...
chrome.extension.sendRequest = async function overriddenSendRequest(
  request,
  sendResponse
) {
  if (typeof request !== "object" || typeof request.method !== "string") {
...
function virtualKeyboardChromeExtension_make_object_visible() {
  if (virtualKeyboardChromeExtensionClickedElem != null) {
    ...
    if (virtualKeyboardChromeExtensionFullScreenState && intelligentScroll) {
      ...
      if (top == self)
        top =
          virtualKeyboardChromeExtensionClickedElem.documentOffsetTop() -
...
function virtualKeyboardChromeExtension_open_part2(pos) {
  ...
  if (intelligentScroll) {
    if (pos == undefined) {
      pos = virtualKeyboardChromeExtension_getElementPositionY(
        virtualKeyboardChromeExtensionClickedElem
      );
    }
    var availCanvasHeight =
      window.innerHeight -
      document.getElementById("virtualKeyboardChromeExtension").offsetHeight;
          ...
          if (virtualKeyboardChromeExtensionTouchEvents == "true") {
            m[i].ontouchstart = function (ent) {
              ...
              document.getElementById(
                ...
                window.innerHeight - ent.touches[0].clientY + 20 + "px";
              document
                .getElementById(
                  "virtualKeyboardChromeExtensionOverlay" +
                    this.getAttribute("_menu")
            ...
            m[i].onmousedown = function (ent) {
              ...
              document.getElementById(
                ...
                window.innerHeight - window.event.clientY + 20 + "px";
              document
                .getElementById(
                  "virtualKeyboardChromeExtensionOverlay" +
                    this.getAttribute("_menu")
...
if (top == self) {
  ...
  //       virtualKeyboardChromeExtension_make_object_visible();
  //       virtualKeyboardChromeExtensionElemType =
  //         virtualKeyboardChromeExtensionClickedElem.tagName.toLowerCase();
  //       virtualKeyboardChromeExtension_inputTypesRender();
  //       var pX = request.posX;
  //       var pY = request.posY;
